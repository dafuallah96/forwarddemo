...
from django.views.generic import TemplateView, View  #and TemplateView extends the base class to make it also render a template.
...
class HomePageView(TemplateView):
    def get(self,request,**kwargs): #as our function’s argument when we have doubts about the number of  arguments we should pass in a function.” 
